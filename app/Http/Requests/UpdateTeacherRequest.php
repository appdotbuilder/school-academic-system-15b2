...
class UpdateTeacherRequest extends FormRequest
{
    ...
    {
        return [
            'employee_id' => 'required|string|unique:teachers,employee_id,' . $this->route('teacher')->id . '|max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'employee_id.unique' => 'This employee ID is already taken by another teacher.',
